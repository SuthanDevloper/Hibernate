...
public class Test {
	...
	public static void main(String[] args) {
		 ...
		 * 02 .SQLQuery sql_query = session.createSQLQuery("select * from emp1 where esal < ?");
		// 03 . SQLQuery sql_query = session.createSQLQuery("select * from emp1 where esal >= ? and esal <= ?");
				//sql_query.setFloat(0, 1000);
